		...
		return array(
			...
			*/
			...
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_content_composer/archive/cardealer_v1.2.10.zip',
				'required'           => true,
				'version'           => '1.2.10',
			),
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_paypal_checkout/archive/cardealer_v1.1.3.zip',
				'required'           => false,
				'version'           => '1.1.3',
			),
			array(
			...
			array(
				'name'               => 'WooCommerce',
				'slug'               => 'woocommerce',
				'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.2.4.13.zip',
				'required'           => false,
				'version'           => '2.4.13',
			),
			array(
